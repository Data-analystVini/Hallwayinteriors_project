...
# ✅ Google Sheets Setup — Using environment variable instead of credentials.json
GOOGLE_CREDS = os.environ.get("GOOGLE_CREDENTIALS")  # Load JSON from Render environment variable
...
sheet = client.open("Expenses Tracker").sheet1  # Make sure the name matches exactly
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=81)  # Required for Render or Replit
